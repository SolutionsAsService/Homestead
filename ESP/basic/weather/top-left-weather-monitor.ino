...
void drawDisplay() {
  ...
  // Top row: icons side by side
  drawWeatherIcon(currIcon, 0, 0);
  drawWeatherIcon(nextIcon, 12, 0);

  // Line 1: Now and humidity (to right of icons)
  ...
  // Line 3: forecast temp and description
